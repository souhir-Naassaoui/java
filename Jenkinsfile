pipeline {
    ...
    environment {
        DOCKER_IMAGE = "souhir98/hello-app"
    ...
    stages {
        ...
        stage('Build') {
            steps {
                echo 'Construction de l\'application Java...'
                sh './mvnw clean package -DskipTests' // Utilise Maven Wrapper pour construire le projet
            }
        }
